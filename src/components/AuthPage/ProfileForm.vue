      ...
      <form class="form" @submit.prevent="save">
        <div class="grid">
          <div>
            ...
            <input id="fn" class="input" v-model.trim="firstName" placeholder="Jane" required />
          </div>
          <div>
...
function onPopEnd() {
  if (popping.value) {
    popping.value = false;    // reset animation flag
...
<style scoped>
/* Fill screen and center the card */
.center-wrap {
  min-height: 100svh;
  min-height: 100%;
  min-height: 100%;
...
.avatar-circle.pop {
  animation: bubbleZoom 900ms ease-in-out 1;
}
